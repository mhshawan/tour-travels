...
import { faTrain, faPlane, faPassport, faGlobe, faNetworkWired, faPhone, faAddressBook } from '@fortawesome/free-solid-svg-icons';
...
const About = () => {
    ...
    const passportICon = <FontAwesomeIcon icon={faPassport} />
    const globeICon = <FontAwesomeIcon icon={faGlobe} />
    const networkICon = <FontAwesomeIcon icon={faNetworkWired} />
                        ...
                        <Col md={6} sm={6} xs={12}>
                            ...
                            <Container fluid>
                                <Row>
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-1">{networkICon}</div>
                                    ...
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-2">{addressbookICon}</div>
                                            <div className="why-choose-list-title">
                                ...
                                <Row>
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-3">{phoneICon}</div>
                                            <div className="why-choose-list-title">
                                                <h2>24/7 Service</h2>
                                            </div>
                                        </div>
                                    ...
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-4">{passportICon}</div>
                                            <div className="why-choose-list-title">
                                                <h2>Passport Support</h2>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
