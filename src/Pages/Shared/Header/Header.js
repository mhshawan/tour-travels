                    ...
                    <Row>
                        <Navbar variant="light" collapseOnSelect expand="md">
                            ...
                            <Navbar.Collapse className='justify-content-end nav-menu'>
                                ...
                                <Nav.Link activeStyle={activeLink} as={NavLink} to="/tour">Tour Plan</Nav.Link>
                                <Nav.Link activeStyle={activeLink} as={NavLink} to="/contact">Contact</Nav.Link>
                                {
                                    user.email && <Nav.Link activeStyle={activeLink} as={NavLink} to="/orderList">Order List</Nav.Link>
                                }
                                {
                                    user.email && <Nav.Link activeStyle={activeLink} as={NavLink} to="/manageOrder">Manage All Order</Nav.Link>
                                }
                                {
